...
import { useReviewContext } from '../../pages/user/Contact'; // Import the review context
    ...
    return (
        <div className="event-page">
            ...
            <div className="review">
                <h1 style={{ color: "#0E86A9", textAlign: "center" }}>
                        ...
                        <div key={index} className="review-item">
                            <div className="ratings">
                                ...
                                {Array.from({ length: 5 - review.rating }).map((_, i) => (
                                    <i key={i} className="fas fa-star" style={{ color: 'gray' }}></i>
                                ))}
                                <p>{review.username}</p>
                            </div>
                            <p>{review.review}</p>
